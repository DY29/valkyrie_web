...
'time'+ time_format)
    ...
    # 데이터 저장
    contract = Contract_LCR(contractname=contractname, contract_id = contract_id, sha256=hash, filename='LCR_' + time_format + '.txt', Created=time_format,a=a, b=b,c=c,d=d,e=e,f=f, g=g,h=h,i=i,j=j,k=k,l=l,m=m,n=n,o=o)
...
'time' + time_format
    ...
    # 데이터 저장
    contract = Contract_CI(contractname=invoicename, sha256=hash, filename='CI_' + time_format + '.txt', Created=time_format,a=a, b=b,c=c,d=d,e=e,f=f, g=g,h=h,i=i,j=j,k=k,l=l,m=m,n=n,o=o, p=p, q=q, r=r)
...
'15.Original B/L:' + o + '\n'
 'time' + time_format)
    ...
    # 데이터 저장
    contract = Contract_SR(contractname=srname, contract_id=contract_id, sha256=hash, filename='SR_' + time_format + '.txt', Created=time_format,a=a, b=b,c=c,d=d,e=e,f=f, g=g,h=h,i=i,j=j,k=k,l=l,m=m,n=n,o=o)
...
'time' + time_format)
    ...
    # 데이터 저장
    contract = Contract_LC(contractname=letteroflc, contract_id=contract_id, sha256=hash, filename='LC_' + time_format + '.txt', Created=time_format,a=a, b=b,c=c,d=d,e=e,f=f, g=g,h=h,i=i,j=j,k=k,l=l,m=m,n=n,o=o, p=p, q=q, r=r, s=s, t=t, u=u, v=v, w=w, x=x, y=y, z=z, aa=aa, bb=bb, cc=cc, dd=dd, ee=ee, ff=ff, gg=gg)
...
def submit4_1(request):
    ...
    # 데이터 저장
    contract = Contract_BL(contractname=contractname, contract_id=contract_id, sha256=hash, filename='BL_' + time_format + '.txt', Created=time_format,a=a, b=b,c=c,d=d,e=e,f=f, g=g,h=h,i=i,j=j)
...
def submit4_2(request):
    ...
    # 데이터 저장
    contract = Contract_DO(contractname=contractname, contract_id=contract_id, sha256=hash, filename='DO_' + time_format + '.txt', Created=time_format, a=a, b=b,c=c,d=d,e=e,f=f, g=g)
...
def detail_ing(request):
    result_dict ={}
    user_id = request.session['user_id']
    member = Member.objects.get(user_id=user_id)
    contract_id = request.POST['contract_id']
    contract_all= Contract_LCR.objects.filter(contract_id=contract_id)
    return render(request, 'app/detail_ing.html',{'contract_all':contract_all})

def detail_ing2(request):
    result_dict ={}
    user_id = request.session['user_id']
    member = Member.objects.get(user_id=user_id)
    contract_id = request.POST['contract_id']
    contract_all= Contract_CI.objects.filter(contract_id=contract_id)
    return render(request, 'app/detail_ing2.html',{'contract_all':contract_all})

def detail_ing2_1(request):
    result_dict ={}
    user_id = request.session['user_id']
    member = Member.objects.get(user_id=user_id)
    contract_id = request.POST['contract_id']
    contract_all= Contract_SR.objects.filter(contract_id=contract_id)
    return render(request, 'app/detail_ing2_1.html',{'contract_all':contract_all})

def detail_ing3(request):
    result_dict ={}
    user_id = request.session['user_id']
    member = Member.objects.get(user_id=user_id)
    contract_id = request.POST['contract_id']
    contract_all= Contract_LC.objects.filter(contract_id=contract_id)
    return render(request, 'app/detail_ing3.html',{'contract_all':contract_all})

def detail_ing4_1(request):
    result_dict ={}
    user_id = request.session['user_id']
    member = Member.objects.get(user_id=user_id)
    contract_id = request.POST['contract_id']
    contract_all= Contract_BL.objects.filter(contract_id=contract_id)
    return render(request, 'app/detail_ing4_1.html',{'contract_all':contract_all})

def detail_ing4_2(request):
    result_dict ={}
    user_id = request.session['user_id']
    member = Member.objects.get(user_id=user_id)
    contract_id = request.POST['contract_id']
    contract_all= Contract_DO.objects.filter(contract_id=contract_id)
    return render(request, 'app/detail_ing4_2.html',{'contract_all':contract_all})
...
def Form_new(request):
    if request.method == "POST":
        form = Contract_LCR_Form(request.POST)
        if form.is_valid():
