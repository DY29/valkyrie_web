...
urlpatterns = [
    ...
    path('LCR/detail_ing/', views.detail_ing, name='detail_ing'),
    path('CI/detail_ing/', views.detail_ing2, name='detail_ing2'),
    path('SR/detail_ing/', views.detail_ing2_1, name='detail_ing2_1'),
    path('LC/detail_ing/', views.detail_ing3, name='detail_ing3'),
    path('BL/detail_ing/', views.detail_ing4_1, name='detail_ing4_1'),
    path('DO/detail_ing/', views.detail_ing4_2, name='detail_ing4_2'),
